...
bglevel1Img = loadImage("level/bgnew.jpg");
bglevel2Img=loadImage("level/bglevel2.jpeg")
...
level2gamebg.scale=10


player=createSprite(80,height-height/4,100,100)
...
stroke("black")
strokeWeight(5)
  text(" The Player has to score 500 points",width/4,height/4)
...
//if(frameCount % 50==0){
  ...
  player.setCollider("circle",-20,0,80)
...
//score = score +(Math.round(getFrameRate()/60))
invisibleground2=createSprite(width/2,height-100,width,10)
...
if (keyDown("space") && player.y>=height/6){
player.velocityY=-15
}
